...
function updateView() {
    if (visionActual === 'table') {
        document.getElementById('contenido').innerHTML = generateTable(electronica);
    } else if (visionActual === 'list') {
        document.getElementById('contenido').innerHTML = generateList(electronica);
    }
}
function generateList(electronica) {
    return electronica.map(product => `
...
function generateTable(electronica) {
    return `
        <table>
            <thead>
                <tr>
...
function showProductDetails(productId) {
    const producto = electronica.find(product => product.id === productId);
    if (producto) {
